...
function intern() {
    let internStudent = new Worker 
    ("Bob", 21, 110, 0, 10)
    // running the goToWork method
    internStudent.goToWork()
    // Returning intern object
...
function manager() {
    ...
    // running the doSomethingFun method
    Manager.doSomethingFun()
    return Manager;
}

// Calling intern and manager object
console.log(intern());
console.log(manager());